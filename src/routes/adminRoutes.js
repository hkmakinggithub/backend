...
// By applying this here, EVERY route in this file requires Admin authentication.
// router.use(protect, adminOnly);

// Health Check
router.get('/test', (req, res) => res.json({ success: true, message: 'Admin API is secured and working!' }));

// Dashboard
router.get('/dashboard', adminController.getDashboard);
router.get('/dashboard/:cityId', adminController.getDashboardByCity);

// Users
router.get('/users', adminController.getUsers);
router.get('/users/city/:cityId', adminController.getUsersByCity);
router.get('/users/:id', adminController.getUserById);
router.put('/users/:id', adminController.updateUserRole);
router.delete('/users/:id', adminController.deleteUser);

// Cities (Admin-specific overrides)
...
router.get('/businesses/city/:cityId', adminController.getBusinessesByCity);
router.get('/pending-businesses', adminController.getPendingBusinesses);
router.get('/pending-businesses/city/:cityId', adminController.getPendingBusinessesByCity);
router.post('/add-business', adminController.addBusiness);
router.delete('/businesses/:id', adminController.deleteBusiness);

// Reviews
router.get('/reviews', adminController.getReviews);
router.get('/reviews/city/:cityId', adminController.getReviewsByCity);
router.delete('/reviews/:id', adminController.deleteReview);

// Utilities
router.get('/business-form-data', adminController.getFormData);
