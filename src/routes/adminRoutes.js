...
// // Locate your user route group and add the GET /:id route
// router.get('/users', adminController.getUsers);

// // 🟢 ADD THIS LINE: Maps GET /api/admin/users/123 to your controller
...
// 2. Get Users by City (MUST BE ABOVE /users/:id to prevent routing crashes)
router.get('/users/city/:cityId', async (req, res) => {
  try {
    const { cityId } = req.params;
    const cityResult = await query('SELECT name FROM cities WHERE id = $1', [cityId]);
